...
{{-- <img src="./images/BGcobro2.jpg" style="max-height: 300px; max-width: 300px" alt=""> --}}
<h1  class="conf" style="font-size:25px; left: 675px; top: {{$NoCuenta}}px; color: #c80000">No. {{$data->id}}</h1>
